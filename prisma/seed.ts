...
async function main() {
  ...
  const wedding = await prisma.event.create({
    data: {
      ...
      description:
        "A beautiful outdoor wedding celebration in the garden. Join us for an unforgettable day filled with love, laughter, and joy.",
  ...
  const collegeFest = await prisma.event.create({
    data: {
      ...
      description:
        "Three days of music, food, and fun! Featuring local and international artists.",
      shortCode: await generateShortCode(),
      startDate: festStart,
      endDate: festEnd,
  ...
  for (const template of happeningNowEvents) {
    ...
    const scheduleItems = [
      ...
      },
      {
        title: "Main Activity",
        startTime: 0.25,
        endTime: template.duration - 0.25,
        location: "Main Area",
      },
      {
        title: "Closing & Networking",
        startTime: template.duration - 0.25,
    ...
    const announcementMessages = [
      {
        ...
        message: "Get ready! The event will begin shortly.",
      },
      {
        title: "Live Now!",
        message: "We're live! Join us if you haven't already.",
      },
      {
        title: "Reminder",
        message: "Don't forget about the event happening today!",
      },
    ];
    ...
    for (let j = 0; j < numAnnouncements; j++) {
      const announcement =
        announcementMessages[j % announcementMessages.length];
  ...
  const eventTemplates = [
    {
      ...
      description:
        "Connect with fellow entrepreneurs, investors, and tech enthusiasts. Food, drinks, and great conversations!",
      type: "CORPORATE" as const,
      visibility: "PUBLIC" as const,
      admin: admin1,
      daysOffset: 10,
    ...
    },
    {
      ...
      description:
        "Join us for team building activities, workshops, and fun! A weekend of collaboration and celebration.",
      type: "CORPORATE" as const,
    ...
    },
    {
      ...
      description:
        "Celebrate our graduates! Food, music, and memories. All friends and family welcome.",
    ...
    },
    {
      ...
      description:
        "Outdoor BBQ with games, music, and fun for the whole family. Bring your appetite!",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin1,
      daysOffset: 5,
    ...
    },
    {
      ...
      description:
        "An evening of smooth jazz, cocktails, and sophisticated vibes. Dress code: Smart casual.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin2,
      daysOffset: 12,
    ...
    },
    {
      ...
      description:
        "Be the first to see our revolutionary new product! Live demos, Q&A, and exclusive early access.",
      type: "CORPORATE" as const,
      visibility: "PUBLIC" as const,
      admin: admin3,
      daysOffset: 18,
    ...
    },
    {
      ...
      description:
        "Elegant evening supporting local charities. Black tie optional. Silent auction and live entertainment.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin1,
      daysOffset: 25,
    ...
    },
    {
      ...
      description:
        "48-hour coding competition. Build something amazing, win prizes, and network with developers.",
      type: "COLLEGE_FEST" as const,
      visibility: "PUBLIC" as const,
      admin: admin2,
      daysOffset: 35,
    ...
    },
    {
      ...
      description:
        "Join us for an evening of celebration, dancing, and joy. Formal attire requested.",
    ...
    },
    {
      ...
      description:
        "Fun-filled party with games, cake, and entertainment for kids of all ages. Parents welcome!",
    ...
    },
    {
      ...
      description:
        "A day of mindfulness, yoga sessions, meditation, and healthy meals. Rejuvenate your mind and body.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin2,
      daysOffset: 15,
    ...
    },
    {
      ...
      description:
        "Exclusive preview of new contemporary art collection. Wine and hors d'oeuvres served.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin3,
      daysOffset: 20,
    ...
    },
    {
      ...
      description:
        "Big game viewing party! Large screens, great food, and enthusiastic fans. All welcome!",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin1,
      daysOffset: 3,
    ...
    },
    {
      ...
      description:
        'Monthly book discussion. This month: "The Future of Technology". Light refreshments provided.',
      type: "OTHER" as const,
      visibility: "UNLISTED" as const,
      admin: admin2,
      daysOffset: 28,
    ...
    },
    {
      ...
      description:
        "Learn to cook a gourmet meal, then enjoy it together! All skill levels welcome.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin3,
      daysOffset: 22,
    ...
    // Pop Culture Themed Events
    {
      ...
      description:
        "The most exclusive mutant event of the year. Formal attire required. Join the X-Men for an evening of elegance and celebration.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin1,
      daysOffset: 40,
    ...
    },
    {
      name: "Met Gala 2024",
      description:
        "Fashion's biggest night. The Metropolitan Museum of Art Costume Institute Gala. Black tie, themed attire.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin2,
      daysOffset: 45,
    ...
    },
    {
      ...
      description:
        "Exclusive fashion showcase inspired by the iconic film. High fashion, high stakes.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin3,
      daysOffset: 35,
    ...
    },
    {
      ...
      description:
        "A gathering of beings from across the galaxy. Discuss diplomacy, trade, and the future of the galaxy.",
      type: "CORPORATE" as const,
      visibility: "PUBLIC" as const,
      admin: admin1,
      daysOffset: 50,
    ...
    },
    {
      ...
      description:
        "The Triwizard Tournament Yule Ball. Formal wizarding attire required. Dancing, feasting, and magical entertainment.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin2,
      daysOffset: 60,
      ...
      duration: 5,
      location:
        "Hogwarts Great Hall, Hogwarts School of Witchcraft and Wizardry, Scotland",
    },
    {
      name: "LOTR Shire Festival",
      description:
        "A celebration of peace and prosperity in the Shire. Food, music, fireworks, and good cheer for all hobbits and friends.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin3,
      daysOffset: 38,
    ...
    },
    {
      ...
      description:
        "A multiversal gathering of Spider-People. Celebrate heroism, responsibility, and the power of choice.",
      type: "OTHER" as const,
      visibility: "PUBLIC" as const,
      admin: admin1,
      daysOffset: 42,
    ...
    },
    {
      ...
      description:
        "Vought International's annual company BBQ. Free food, entertainment, and meet your favorite Supes!",
      type: "CORPORATE" as const,
      visibility: "PUBLIC" as const,
      admin: admin2,
      daysOffset: 25,
    ...
    },
    {
      ...
      description:
        "The ultimate anime fan gathering. Cosplay contest, panels, screenings, and meet fellow weebs from across dimensions.",
      type: "COLLEGE_FEST" as const,
      visibility: "PUBLIC" as const,
      admin: admin3,
      daysOffset: 55,
      ...
      duration: 12,
      location:
        "Anime Convention Center, 2000 Otaku Street, Los Angeles, CA 90015",
    },
    {
      name: "Breaking Bad Chemistry Workshop",
      description:
        "Advanced chemistry techniques and applications. For educational purposes only. Safety protocols strictly enforced.",
      type: "CORPORATE" as const,
      visibility: "PUBLIC" as const,
      admin: admin1,
      daysOffset: 32,
    ...
    },
    {
      ...
      description:
        "Showcase of Wakandan technology and innovation. Vibranium applications, advanced AI, and sustainable energy solutions.",
      type: "CORPORATE" as const,
      visibility: "PUBLIC" as const,
      admin: admin2,
      daysOffset: 48,
  ...
  const birthdaySchedule = [
    ...
    {
      title: "Cake Cutting",
      description: "Birthday cake celebration",
      startTime: 20,
      endTime: 20.5,
      location: "Main Hall",
    },
  ...
  const scheduleTemplates = [
    ...
    [
      {
        ...
        startTime: 18,
        endTime: 19.5,
        location: "Museum Steps",
      },
      {
        title: "Exhibition Viewing",
        startTime: 19.5,
        endTime: 21,
        location: "Costume Institute",
      },
      {
        title: "Dinner & Speeches",
        startTime: 21,
        endTime: 22.5,
        location: "Temple of Dendur",
      },
      {
        title: "After Party",
        startTime: 22.5,
    ...
    [
      {
        ...
        startTime: 14,
        endTime: 14.5,
        location: "Party Field",
      },
      {
        title: "Food & Ale Service",
        startTime: 14.5,
        endTime: 17,
        location: "Feast Tables",
      },
      {
        title: "Music & Dancing",
        startTime: 17,
    ...
    [
      {
        title: "Multiverse Portal Opening",
        startTime: 16,
        endTime: 16.5,
        location: "Main Plaza",
      },
      {
        title: "Spider-People Meetup",
        startTime: 16.5,
        endTime: 18,
        location: "Meetup Zone",
      },
      {
        title: "Hero Showcase",
        startTime: 18,
    ...
    [
      {
        ...
        startTime: 12,
        endTime: 12.5,
        location: "Rooftop Entrance",
      },
      {
        title: "BBQ Lunch Service",
        startTime: 12.5,
        endTime: 14.5,
        location: "Grill Area",
      },
      {
        title: "Supe Meet & Greet",
        startTime: 14.5,
        endTime: 16,
        location: "Meet & Greet Zone",
      },
      {
    ...
    [
      {
        title: "Registration & Cosplay Check-in",
        startTime: 10,
        endTime: 11,
      ...
      {
        title: "Anime Screenings",
        startTime: 17,
        endTime: 19,
        location: "Screening Rooms",
      },
      {
        title: "Merchandise & Artist Alley",
        startTime: 19,
        endTime: 21,
  ...
  const guestCountsPerEvent = [
    12, 8, 15, 20, 10, 18, 14, 25, 16, 12, 8, 6, 22, 5, 9, 30, 25, 15, 35, 28,
    22, 20, 18, 25, 15, 20,
  ];
  ...
  const announcementTemplates = [
    {
      title: "Welcome!",
      message: "Thank you for joining us! We're excited to have you here.",
    },
    {
      title: "Event Starting Soon",
      message:
        "The event will begin shortly. Please make your way to the main area.",
    },
    {
      title: "Important Update",
      message: "Please note the updated schedule. Check the app for details.",
    },
    { title: "Reminder", message: "Don't forget to check in when you arrive!" },
    {
      title: "Schedule Change",
      message: "There has been a slight change to today's schedule.",
    },
    {
      title: "Thank You",
      message: "Thank you for being part of this amazing event!",
    },
    {
      title: "Next Activity",
      message: "The next activity is starting in 10 minutes.",
    },
  ...
  for (const event of events) {
    const eventAdmin =
      [admin1, admin2, admin3].find((a) => a.id === event.adminId) || admin1;
  ...
  const notificationTemplates = [
    ...
    { title: "Welcome", message: "Welcome to the event!", success: true },
    {
      ...
      message: "Your event is about to begin",
      success: true,
    },
    {
  ...
  for (const event of events) {
    ...
    for (let i = 0; i < numNotifications; i++) {
      ...
      const randomGuest =
        eventGuests[Math.floor(Math.random() * eventGuests.length)];
      if (!randomGuest) continue;

      // Get devices for this guest
      const guestDevices = allDevices.filter(
        (d) => d.userId === randomGuest.userId
      );
      if (guestDevices.length === 0) continue;

      const device =
        guestDevices[Math.floor(Math.random() * guestDevices.length)];
      const template =
